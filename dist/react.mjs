import { internal, isFunction, isEmpty, when, isObservable, trackSelector, isPrimitive, observable, computeSelector, isArray, isMap, isObservableValueReady, isPromise, getNode as getNode$1, linked, observe, whenReady } from '@legendapp/state';
